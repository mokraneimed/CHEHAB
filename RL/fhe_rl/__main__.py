...
def main(args=None):
    ...
    if mode == "train":
        ...
        train_agent("./fhe_rl/datasets/benchmarks.txt", embeddings, total_timesteps=20_000, num_envs=1, keys_schedule_type="step", auto_transition=False, max_keys_weight=0.01, update_buffer=False)
